...
dtifit -k ${subjid}-preproc-lowb-data.nii.gz -o ${subjid} -m T1w_mask_inDWIspace.nii.gz -r ${subjid}-preproc-lowb-data.bvec -b ${subjid}-preproc-lowb-data.bval --sse -w --save_tensor
